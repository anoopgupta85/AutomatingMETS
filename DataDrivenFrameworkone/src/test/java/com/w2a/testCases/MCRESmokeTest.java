...
public class MCRESmokeTest extends TestBase{
	
	@Test
	public void MAApplication(){
		
		System.setProperty("org.uncommons.reportng.escape-output", "false");
		driver.findElement(By.xpath(or.getProperty("LoginPageUserName_XPATH"))).sendKeys("zafartc135");
        ...
        element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(or.getProperty("GettingStartedLink_XPATH"))));
		 ...
		 element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(or.getProperty("PleaseTellAbtYouNextBtn_XPATH")))); 
		   ...
		   driver.findElement(By.xpath(or.getProperty("InfAbtyouFrstName_XPATH"))).sendKeys("SSKayla");
		   driver.findElement(By.xpath(or.getProperty("InfAbtyouLastName_XPATH"))).sendKeys("SSKim");
		   ...
		   driver.findElement(By.xpath(or.getProperty("InfAbtyouNeverMarried_XPATH"))).click();
			 ...
			 element.sendKeys("444444165");	
			// element.sendKeys("567442600");
			 ...
			 driver.findElement(By.xpath(or.getProperty("MAIncomeAmount_XPATH"))).sendKeys("21000");
			 ...
			 driver.findElement(By.xpath(or.getProperty("MAFinalPageFirstName_XPATH"))).sendKeys("SSKyla");
			 driver.findElement(By.xpath(or.getProperty("MAFinalPageLastName_XPATH"))).sendKeys("SSKim");
