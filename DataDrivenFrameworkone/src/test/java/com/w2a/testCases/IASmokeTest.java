...
public class IASmokeTest extends TestBase{
	
	@Test
	public void MAApplication(){
		
		System.setProperty("org.uncommons.reportng.escape-output", "false");
		driver.findElement(By.xpath(or.getProperty("LoginPageUserName_XPATH"))).sendKeys("Smkstst1tc1");
        ...
        element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(or.getProperty("GettingStartedLink_XPATH"))));
		 ...
		 element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(or.getProperty("PleaseTellAbtYouNextBtn_XPATH")))); 
		   ...
		   driver.findElement(By.xpath(or.getProperty("InfAbtyouFrstName_XPATH"))).sendKeys("Chuck");
		   driver.findElement(By.xpath(or.getProperty("InfAbtyouLastName_XPATH"))).sendKeys("Newman");
		   ...
		   driver.findElement(By.xpath(or.getProperty("InfAbtyouNeverMarried_XPATH"))).click();
			 ...
			 element.sendKeys("12969 First Ave W");	
			 driver.findElement(By.xpath(or.getProperty("InfAbtyouAddressLine2_XPATH"))).sendKeys("P O Box 44");
			 driver.findElement(By.xpath(or.getProperty("InfAbtyouAptSuit_XPATH"))).sendKeys("11");
			 driver.findElement(By.xpath(or.getProperty("InfAbtyouCity_XPATH"))).sendKeys("Minneapolis");
			 ...
			 element.sendKeys("567442613");	
			 //element.sendKeys("444444145");	
			 ...
			 driver.findElement(By.xpath(or.getProperty("MAIncomeAmount_XPATH"))).sendKeys("75000");
			 ...
			 ((JavascriptExecutor)driver).executeScript("scroll(0,400)");
			 // For uQHP - Comment below 2 lines.
			...
			element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(or.getProperty("MAEmployerSponsoredCovInfoNextBtn_XPATH"))));           // 
			 ...
			 driver.findElement(By.xpath(or.getProperty("MAFinalPageFirstName_XPATH"))).sendKeys("Chuck");
			 driver.findElement(By.xpath(or.getProperty("MAFinalPageLastName_XPATH"))).sendKeys("Newman");
