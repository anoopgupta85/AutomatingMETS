...
public class TTMCRESMOKETEST {
	...
	public static void main(String[] args) throws InterruptedException {
      ...
      Map<String, Object> prefs = new HashMap<String, Object>();
		...
		driver.findElement(By.xpath("//*[@id='username']")).sendKeys("Testcasee225");
     ...
     Thread.sleep(3000);
      driver.findElement(By.xpath("html/body/center/form/table/tbody/tr[1]/td[2]/input")).sendKeys("Testcasee225");
      ...
      Thread.sleep(2000);
       ...
       element.click();	
        ...
        //  Information About you
		   Thread.sleep(3000);
		   driver.findElement(By.xpath("//*[@id='__o3id6']")).sendKeys("SSHimanshu");
		   driver.findElement(By.xpath("//*[@id='__o3id8']")).sendKeys("SSJain");
		   ...
		   driver.findElement(By.xpath("//*[@id='__o3idc']")).sendKeys("01/10/1990");											   //  Input Date of Birth
		   ...
		   driver.findElement(By.xpath("//*[@id='__o3id12']")).sendKeys("Near Water tank");									//  Add Address Line 2
		   driver.findElement(By.xpath("//*[@id='__o3id13']")).sendKeys("235");														// Add Apartment number
		   ...
		   driver.findElement(By.xpath("//*[@id='__o3id26']")).sendKeys("5377");														// Input last 4
		 ...
		 /*  frames = driver.findElements(By.tagName("iframe"));
		   ...
		   element.sendKeys("444443375");																												// Input SSN
		   ...
		   Thread.sleep(2100);
		  // In case of SEP Period for 2018, Use below Line of code for Annual Income Page. 
		  // In case of System Date for 2019 annual enrollment period  comment below 2 lines of code.
		   
		   driver.findElement(By.xpath("//*[@id='main']/div/div[7]/table/tbody/tr/td/span[2]/span")).click(); 															// Click on Next Button on Annual Income Screen
		   Thread.sleep(2000);
		 //In case of System Date for 2019 annual enrollment period  uncomment below 4 lines of code.
		 // In case of SEP period for 2018, comment below 4 lines.
			  ...
			  driver.findElement(By.xpath("//*[@id='main']/div/div[8]/table/tbody/tr/td/span[2]/span")).click();                            								// Click on Next Button on Annual Income Screen
			  Thread.sleep(2100);
			  
			  element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='main']/div/div[3]/table/tbody/tr/td/span/span")));   	// Click on Next Button on More about your household in Additional Household Information Section
			   element.click();
			 ...
			 element.click();
			   ...
			   driver.findElement(By.xpath("html/body/form/div/div[3]/div[5]/div/div/div/div/div[16]/table/tbody/tr/td[1]/div[2]/table/tbody/tr/td[1]/div/div/input")).sendKeys("ssNikhil");
			   driver.findElement(By.xpath("html/body/form/div/div[3]/div[5]/div/div/div/div/div[16]/table/tbody/tr/td[3]/div[2]/table/tbody/tr/td[1]/div/div/input")).sendKeys("ssGupta");
